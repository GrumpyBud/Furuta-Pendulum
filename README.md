...
- [`teensy_uart_web/`](teensy_uart_web/) is the Teensy 4.1 + ODrive S1 isolated-UART controller with AS5048A SPI input and a guided local web dashboard for setup, testing, bounded tuning, logging, and run control.
