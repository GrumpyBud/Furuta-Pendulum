...
| Swing-up hard clamp (including guarded trials) | `10.0 A` | `0.3063 N m` |
| User-selectable swing ceiling | `9.79 A` | `0.3000 N m` |
| Upright tuning trial | `4.0 A` | `0.1225 N m` |
| Automatic arm centering | `9.79 A` | `0.3000 N m` |
