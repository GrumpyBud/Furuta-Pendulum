(() => {
  ...
  function startDemo() {
    ...
    state.demoTimer = setInterval(() => {
      ...
      processLine(`@T,${tick * 40},TEST,${arm},${pendulum},0.02,0.08,0,1,1,OK,1,8192,118,0,0,-0.07000,1.60000,-0.06920,0.09000,0,2100,2900,1,0,1,0,1.0000,0.0300,0.1800,0.1600,0.4500,0.01,0.03,-`);
    }, 40);
